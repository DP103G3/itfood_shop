...
public class DeliveryOrderWebSocketClient extends WebSocketClient {
    private String TAG = "TAG_DeliveryOrderWebSocketClient";
    private LocalBroadcastManager broadcastManager;

    public DeliveryOrderWebSocketClient(URI serverUri, Context context) {
